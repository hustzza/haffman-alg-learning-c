/*
 * Определяется динамическая структура данных
 * предназначенная для хранения уникальных символов в
 * введенном тексте, количество их вхождений в текст
 * и вероятность вхождения.
 *
 */
